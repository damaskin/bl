...
class Auth extends Controller {
	...
	{
		$data['users'] = $this->ion_auth->get_user();
...
//		if (!$this->ion_auth->logged_in() || !$this->ion_auth->is_admin())
		if (!$this->ion_auth->logged_in() || $data->id !== $iduser)
		{
			redirect('auth', 'refresh');
		}
//		if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin())
...
//			}
	...
	public function user_list() {
		...
		$this->load->view('header');
		$this->load->view('menu', $data_user_top_menu);
		$this->load->view('auth/users_list', $this->data);
		$this->load->view('footer');
	}
	...
	public function user($id) {
		...
		$data['data_users'] = $this->ion_auth->get_users();
		$data['id_user'] = $id;
		$data_user_top_menu['users'] = $this->ion_auth->get_user();

		$this->load->view('header');
		$this->load->view('menu', $data_user_top_menu);
		$this->load->view('profile_user_id', $data);
		$this->load->view('footer');
